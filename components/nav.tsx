...
export function Nav({ menu, whatsapp, whatsappUrl }: NavProps) {
        ...
        {whatsappUrl ? (
          <Magnetic strength={0.4}>
            <a
              ...
              aria-label={whatsapp ? `Conversar com a Sunprime no WhatsApp · ${whatsapp}` : 'WhatsApp Sunprime'}
              className="
                eyebrow flex items-center gap-2 rounded-full border border-gold-500/60 px-4 py-2
                text-gold-200 transition-colors
                hover:border-gold-400 hover:bg-gold-500 hover:text-ink-950
              "
            >
            <svg
              viewBox="0 0 24 24"
            ...
            <span className="hidden sm:inline">
              {whatsapp ? `${whatsapp} · WhatsApp` : 'Falar com a Sunprime'}
            </span>
          ...
          <Link
            href="/contato"
            className="
              eyebrow rounded-full border border-gold-500/60 px-4 py-2
              text-gold-200 transition-colors
              hover:border-gold-400 hover:bg-gold-500 hover:text-ink-950
            "
          >
