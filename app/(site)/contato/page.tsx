...
export default function ContatoPage() {
  ...
  return (
    <div className="bg-ink-950">
      {/* ——— HERO ————————————————————————————————————————————————————————— */}
      <CinematicSection className="relative px-6 pt-28 pb-16 sm:pt-32 sm:pb-20 md:px-10 md:pt-40 md:pb-24">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-base text-ink-200 sm:mt-8 sm:text-lg">
      ...
      <CinematicSection className="px-6 pb-12 md:px-10">
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
          {c.whatsappUrl && c.whatsapp && (
            <Reveal>
              <a
                ...
                className="group relative flex h-full flex-col justify-between gap-8 overflow-hidden rounded-2xl border border-gold-500/40 bg-gradient-to-br from-gold-500 to-gold-600 p-6 text-ink-950 transition-colors hover:from-gold-400 hover:to-gold-500 sm:gap-10 sm:p-8 md:p-10"
              >
          ...
          <Reveal delay={0.1}>
            <a
              href={`tel:${telDigits}`}
              className="group relative flex h-full flex-col justify-between gap-8 overflow-hidden rounded-2xl border border-ink-700 bg-ink-900/60 p-6 text-paper-100 transition-colors hover:border-gold-500/50 sm:gap-10 sm:p-8 md:p-10"
            >
              <div className="flex items-start justify-between">
              ...
              <div>
                <p className="display text-3xl leading-tight text-paper-50 sm:text-4xl md:text-5xl">
                  {c.telefone}
                </p>
      ...
      <CinematicSection className="px-6 py-16 sm:py-20 md:px-10 md:py-28">
        <div className="mx-auto grid max-w-5xl gap-10 md:grid-cols-3 md:gap-12">
          <Reveal>
            ...
            <a
              href={`mailto:${c.email}`}
              className="display mt-4 block break-words text-xl text-paper-50 hover:text-gold-400 sm:mt-6 sm:text-2xl md:text-3xl"
            >
              {c.email}
            </a>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            ...
            <p className="mt-4 text-base leading-snug text-paper-100 sm:mt-6 sm:text-lg">{c.endereco}</p>
            <a
          ...
          {c.redesSociais.length > 0 && (
            <Reveal delay={0.2}>
              ...
              <ul className="mt-4 space-y-3 text-base capitalize sm:mt-6 sm:text-lg">
